...
# Requires Java on PATH (the StageX Android image provides it).
...
PLATFORM_TOOLS_MARKER="$PLATFORM_TOOLS_DIR/.stack-wallet-stagex-sdk"
...
MARKER="$CMDLINE_DIR/.stack-wallet-stagex-sdk"

# Verify Java is available.
if ! command -v java &>/dev/null; then
    echo "ERROR: java not found on PATH."
    if [ "$HOST_OS" = "linux" ]; then
        echo "Run this script through the StageX Android build driver."
        ...
        echo "Set JAVA_HOME to Android Studio's JBR:"
...
done < "$PROJECT_ROOT/contrib/stagex/android-sdk-packages.lock"
