...
class $MwebUtxosTable extends MwebUtxos
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [outputId, address, value, height, blockTime, blocked, used];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<MwebUtxo> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class MwebUtxo extends DataClass implements Insertable<MwebUtxo> {
  ...
  factory MwebUtxo.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return MwebUtxo(
...
typedef $$SparkNamesTableProcessedTableManager = ProcessedTableManager<
    ...
    SparkName,
    PrefetchHooks Function()>;
typedef $$MwebUtxosTableCreateCompanionBuilder = MwebUtxosCompanion Function({
  required String outputId,
  required String address,
  required int value,
  required int height,
...
typedef $$MwebUtxosTableUpdateCompanionBuilder = MwebUtxosCompanion Function({
  Value<String> outputId,
  Value<String> address,
  Value<int> value,
  Value<int> height,
...
class $$MwebUtxosTableTableManager extends RootTableManager<
    _$WalletDatabase,
    $MwebUtxosTable,
    MwebUtxo,
    $$MwebUtxosTableFilterComposer,
...
typedef $$MwebUtxosTableProcessedTableManager = ProcessedTableManager<
    _$WalletDatabase,
    $MwebUtxosTable,
    MwebUtxo,
    $$MwebUtxosTableFilterComposer,
