...
class ChangeNowAPI {
  ...
  Future<dynamic> _makeGetRequestV2(Uri uri, String apiKey) async {
    try {
      ...
      Logging.instance
          .logd("_makeRequestV2($uri) threw: $e\n$s", level: LogLevel.Error);
      rethrow;
    }
  }
  ...
  Future<dynamic> _makePostRequest(
    ...
    try {
      ...
      try {
        ...
        Logging.instance.logd("ChangeNOW api failed to parse: $data",
            level: LogLevel.Error);
        rethrow;
      }
    } catch (e, s) {
      Logging.instance
          .logd("_makePostRequest($uri) threw: $e\n$s", level: LogLevel.Error);
      rethrow;
    }
  }
  ...
  Future<ExchangeResponse<List<Currency>>> getPairedCurrencies({
    ...
    try {
      ...
      Logging.instance
          .logd("getPairedCurrencies exception: $e\n$s", level: LogLevel.Error);
      return ExchangeResponse(
        exception: ExchangeException(
          e.toString(),
          ExchangeExceptionType.generic,
  ...
  Future<ExchangeResponse<ExchangeTransactionStatus>> getTransactionStatus({
    ...
    try {
      ...
      Logging.instance.logd("getTransactionStatus exception: $e\n$s",
          level: LogLevel.Error);
      return ExchangeResponse(
        exception: ExchangeException(
          e.toString(),
