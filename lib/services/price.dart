...
class PriceAPI {
  ...
  Future<Map<Coin, Tuple2<Decimal, double>>> getPricesAnd24hChange(
    ...
    try {
      final uri = Uri.parse(
          "https://api.coingecko.com/api/v3/coins/markets?vs_currency=${baseCurrency.toLowerCase()}&ids=monero,bitcoin&order=market_cap_desc&per_page=10&page=1&sparkline=false");
      // final uri = Uri.parse(
