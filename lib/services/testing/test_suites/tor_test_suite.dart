...
class TorTestSuite implements TestSuiteInterface {
  ...
  Future<TestResult> runTests() async {
    ...
    try {
      ...
      Logging.instance.log(Level.info, ("👍👍👍 All Tor service tests completed successfully!"));
      ...
      Logging.instance.log(Level.info, ("✗ Test failed: ${e.toString()}"));
  ...
  Future<void> _testTorConnection() async {
    ...
    if (currentStatus != TorConnectionStatus.connected) {
      ...
      try {
        ...
        Logging.instance.log(Level.info, ("✓ Tor service reportedly started"));
      } catch (e) {
        throw Exception("Failed to start Tor service: $e");
      }
    } else {
      Logging.instance.log(Level.info, ("✓ Tor service is already connected"));
    ...
    try {
      ...
      Logging.instance.log(Level.info, ("✓ Proxy info retrieved: ${proxyInfo.host.address}:${proxyInfo.port}"));
    ...
    Logging.instance.log(Level.info, ("✓ Tor service looks connected and ready... host and port are valid"));
    Logging.instance.log(Level.info, ("👍 Tor connection test passed"));
  }
  ...
  Future<void> _testProxyFunctionality() async {
    ...
    try {
      ...
      Logging.instance.log(Level.info, ("✓ Proxy info retrieved successfully"));
      ...
      try {
        ...
        if (response.code == 200) {
          Logging.instance.log(Level.info, ("✓ Successfully made HTTP request through Tor proxy"));
          ...
          if (response.body.contains('"IsTor":true')) {
            Logging.instance.log(Level.info, ("✓ Confirmed traffic is routed through Tor network"));
            // TODO: Replace test with a more reliable check.
          } else {
            Logging.instance.log(Level.info, ("⚠ Warning: Response doesn't confirm Tor usage"));
          }
        } else {
    ...
    Logging.instance.log(Level.info, ("👍 Proxy functionality test passed"));
  }
  ...
  Future<void> _testNodeAccessThroughTor() async {
    ...
    try {
      ...
      try {
        ...
        if (pingResult) {
          Logging.instance.log(Level.info, ("✓ Successfully pinged Bitcoin node through Tor"));
        } else {
        ...
        if (serverFeatures.isNotEmpty) {
          Logging.instance.log(Level.info, ("✓ Successfully retrieved server features"));
          ...
          if (genesisHash == bitcoin.genesisHash) {
            Logging.instance.log(Level.info, ("✓ Confirmed connection to valid Bitcoin mainnet node"));
            Logging.instance.log(Level.info, ("Server version: ${serverFeatures['server_version'] ?? 'Unknown'}"));
          } else {
            Logging.instance.log(Level.info, ("⚠ Warning: Genesis hash mismatch. Expected: ${bitcoin.genesisHash}, Got: $genesisHash"));
          }
        } else {
        ...
        if (blockHeader.containsKey('height') && blockHeader.containsKey('hex')) {
          ...
          Logging.instance.log(Level.info, ("✓ Successfully retrieved block header"));
    ...
    Logging.instance.log(Level.info, ("👍 Node access through Tor test passed"));
  }
