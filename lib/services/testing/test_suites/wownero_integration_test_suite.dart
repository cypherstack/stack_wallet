...
class WowneroIntegrationTestSuite implements TestSuiteInterface {
  ...
  Future<TestResult> runTests() async {
    ...
    try {
      ...
      Logging.instance.log(
        Level.info,
        "Starting Wownero integration test suite...",
      );
  ...
  Future<void> _testWowneroMnemonicGeneration() async {
    Logging.instance.log(
      Level.info,
      "Testing Wownero mnemonic generation and wallet creation...",
    );
    ...
    try {
      ...
      await _testWowneroWalletCreation(
        ...
        seedType: lib_wownero.WowneroSeedType.sixteen,
      ...
      Logging.instance.log(
        Level.info,
        "👍 Wownero mnemonic generation tests passed",
      );
    } finally {
      // Cleanup test wallet files.
      await _cleanupTestWallets(["${walletPath}_16", "${walletPath}_25"]);
    }
  }
  ...
  Future<void> _testWowneroWalletCreation({
    ...
    required lib_wownero.WowneroSeedType seedType,
    required int expectedWordCount,
  }) async {
    lib_wownero.Wallet? wallet;

    try {
      // Create new Wownero wallet with specified seed type.
      wallet = await lib_wownero.WowneroWallet.create(
        path: walletPath,
        password: password,
        seedType: seedType,
        seedOffset: "",
      ...
      if (!address.value.startsWith('W')) {
        throw Exception(
          "Generated address does not appear to be a valid Wownero address: ${address.value}",
        );
      }
  ...
  Future<void> _cleanupTestWallets(List<String> walletPaths) async {
    for (final walletPath in walletPaths) {
      try {
        ...
        Logging.instance.log(
          Level.info,
          "Cleaned up test Wownero wallet: $walletPath",
        );
      } catch (e) {
        Logging.instance.log(
          Level.warning,
          "Failed to cleanup Wownero wallet $walletPath: $e",
        );
      }
    }
  }
  ...
  //   Logging.instance.log(
  //     Level.info,
  //     "Testing Stack Wallet Backup round-trip for Wownero...",
  //   );
  //
  //   final tempDir = await StackFileSystem.applicationRootDirectory();
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "✓ All Wownero Stack Wallet Backup round-trip tests passed successfully!",
  //     );
  //   } catch (e) {
  //     Logging.instance.log(
  //       Level.error,
  //       "Wownero Stack Wallet Backup round-trip test failed: $e",
  //     );
  //     rethrow;
  //   }
  // }
  ...
  //   Logging.instance.log(
  //     Level.info,
  //     "Testing ${expectedWordCount}-word Wownero mnemonic backup...",
  //   );
  //
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "Step 1: Creating new ${expectedWordCount}-word Wownero wallet...",
  //     );
  //
  //     originalWallet = await lib_wownero.WowneroWallet.create(
  //       path: walletPath,
  //       password: walletPassword,
  //       seedType: seedType,
  //       seedOffset: "",
  ...
  //       throw Exception(
  //         "Failed to retrieve mnemonic from created Wownero wallet",
  //       );
  //     }
  //
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "Original Wownero mnemonic has ${originalWords.length} words",
  //     );
  //
  //     // Validate the mnemonic format.
  //     if (originalWords.length != expectedWordCount) {
  //       throw Exception(
  //         "Expected ${expectedWordCount}-word mnemonic, got ${originalWords.length} words",
  //       );
  //     }
  //
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "Step 3: Creating Stack Wallet Backup...",
  //     );
  //
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "Step 4: Restoring Stack Wallet Backup...",
  //     );
  //
  ...
  //
  //     final restoredJson =
  //         jsonDecode(restoredJsonString) as Map<String, dynamic>;
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "Step 5: Verifying Wownero mnemonic integrity...",
  //     );
  //
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "Step 6: Testing Wownero wallet restoration with recovered mnemonic...",
  //     );
  //
  //     final testWalletPath =
  //         "${tempDir.path}/test_wownero_restore_${testId}_$suffix";
  ...
  //       Logging.instance.log(
  //         Level.info,
  //         "✓ Successfully restored ${expectedWordCount}-word Wownero wallet from backup mnemonic",
  //       );
  //     } finally {
  ...
  //     Logging.instance.log(
  //       Level.info,
  //       "✓ ${expectedWordCount}-word Wownero Stack Wallet Backup round-trip test passed!",
  //     );
  //     Logging.instance.log(
  //       Level.info,
  //       "✓ Original and restored Wownero mnemonics match perfectly",
  //     );
  //     Logging.instance.log(
  //       Level.info,
  //       "✓ Verified ${originalWords.length}-word Wownero mnemonic integrity",
  //     );
  //     Logging.instance.log(
  //       Level.info,
  //       "✓ Confirmed ${expectedWordCount}-word Wownero wallet can be restored from backup mnemonic",
  //     );
  //   } finally {
  //     // Cleanup.
  //     try {
  ...
  //       Logging.instance.log(
  //         Level.info,
  //         "Cleaned up test files for ${expectedWordCount}-word Wownero backup test",
  //       );
  //     } catch (e) {
  //       Logging.instance.log(
  //         Level.warning,
  //         "Cleanup error for ${expectedWordCount}-word Wownero test: $e",
  //       );
  //     }
  //   }
  // }
