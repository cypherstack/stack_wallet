...
///
/// [CustomSliverFillViewport] places its children in a linear array along the main
...
class CustomSliverFillViewport extends StatelessWidget {
  ...
  const CustomSliverFillViewport({
    ...
    this.padEnds = true,
        ...
        assert(viewportFractionalPadding > 0.0),
        assert(viewportFractionalPadding <= 0.25),
        super(key: key);
  ...
  /// You may want to set this to false if this [CustomSliverFillViewport] is not the only
  ...
  Widget build(BuildContext context) {
    return _SliverFractionalPadding(
      viewportFraction: viewportFractionalPadding,
...
/// See also:
///
///  * [CustomSliverFillViewport], which sizes its children based on the
