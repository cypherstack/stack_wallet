  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        if (current == Level.debug || current == Level.trace)
          Padding(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text: " may log sensitive metadata, such as transaction"
                          " details, addresses, or network activity. While no"
                          " private keys, mnemonics, or credentials will ever "
                          "be logged, enabling these levels could expose "
                          "information that might compromise privacy if "
