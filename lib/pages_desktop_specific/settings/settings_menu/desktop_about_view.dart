...
class DesktopAboutView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    String firoCommit = "fixme";//FIRO_VERSIONS.getPluginVersion();
    String epicCashCommit = "fixme";//EPIC_VERSIONS.getPluginVersion();
    String moneroCommit = "fixme";//MONERO_VERSIONS.getPluginVersion();
