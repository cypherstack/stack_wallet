...
final _twiProvider = ChangeNotifierProvider.family<
  Watcher,
...
>((ref, data) {
  ...
  if (initial == null) {
    initial = TokenWalletInfo(
      ...
      tokenFractionDigits:
          isar.ethContracts.getByAddressSync(data.contractAddress)?.decimals ??
          2,
    );
...
final pTokenWalletInfo = Provider.family<
  TokenWalletInfo,
  ({String walletId, String contractAddress})
>((ref, data) {
