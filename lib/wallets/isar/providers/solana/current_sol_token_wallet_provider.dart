...
final solanaTokenServiceStateProvider = StateProvider<SolanaTokenWallet?>(
  (ref) => null,
);
...
final pCurrentSolanaTokenWallet = Provider<SolanaTokenWallet?>(
  (ref) => ref.watch(solanaTokenServiceStateProvider),
);
