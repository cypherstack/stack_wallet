...
class Fact0rnWallet<T extends ElectrumXCurrencyInterface>
    extends Bip39HDWallet<T>
    with ElectrumXInterface<T>, ExtendedKeysInterface<T>, CoinControlInterface {
  Fact0rnWallet(CryptoCurrencyNetwork network) : super(Fact0rn(network) as T);
    ...
    for (final txData in allTransactions) {
      ...
      if (wasSentFromThisWallet) {
        ...
        if (wasReceivedInThisWallet) {
          ...
          // Fact0rn has special outputs like deadpool bounties + announcements, but they're unsupported.
          // This is where we would check for them.
          // TODO: [prio=none] Check for special Fact0rn outputs.
        }
