...
class EpicSlatepackEntryDialog extends ConsumerStatefulWidget {
  const EpicSlatepackEntryDialog({
    super.key,
  ...
  @override
  ConsumerState<EpicSlatepackEntryDialog> createState() =>
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: TextField(
              minLines: 1,
              maxLines: 5,
              key: const Key("receiveViewEpicSlateFieldKey"),
                        ...
                        child: Row(
                          ...
                          children: [
                            _slateToggleFlag
                                ? TextFieldIconButton(
                                    key: const Key(
                                      "receiveViewClearEpicSlateFieldButtonKey",
                                    ),
                                    onTap: () {
                                ...
                                : TextFieldIconButton(
                                    key: const Key(
                                      "receiveViewPasteEpicSlateFieldButtonKey",
                                    ),
