...
class CreateAutoBackupView extends ConsumerStatefulWidget {
  const CreateAutoBackupView({super.key});
...
class _EnableAutoBackupViewState extends ConsumerState<CreateAutoBackupView> {
  ...
  Future<void> _createEnableAutoBackup() async {
    ...
    if (mounted) {
      ...
      final savedPath = await showLoading(
        ...
        context: context,
        message: "Encrypting initial backup",
        ...
        if (savedPath != null) {
          ...
          await showDialog<dynamic>(
            ...
            builder: (_) => StackOkDialog(
              title: "${AppConfig.prefix} Auto Backup enabled and saved to:",
              message: savedPath,
            ),
          );
          if (mounted) {
