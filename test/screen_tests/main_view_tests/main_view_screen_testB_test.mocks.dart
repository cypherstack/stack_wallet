...
class MockNotesService extends _i1.Mock implements _i10.NotesService {
  ...
  _i6.Future<Map<String, String>> search(String? text) => (super.noSuchMethod(
      ...
      as _i6.Future<Map<String, String>>);
  @override
  _i6.Future<String> getNoteFor({String? txid}) =>
      (super.noSuchMethod(Invocation.method(#getNoteFor, [], {#txid: txid}),
          returnValue: Future<String>.value('')) as _i6.Future<String>);
  @override
  _i6.Future<void> editOrAddNote({String? txid, String? note}) =>
      (super.noSuchMethod(
          Invocation.method(#editOrAddNote, [], {#txid: txid, #note: note}),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> deleteNote({String? txid}) =>
...
class MockLocaleService extends _i1.Mock implements _i11.LocaleService {
  ...
  bool get hasListeners =>
      (super.noSuchMethod(Invocation.getter(#hasListeners), returnValue: false)
          as bool);
  @override
  _i6.Future<void> loadLocale({bool? notify = true}) =>
